...
import { DndContext, DragSource, DropTarget, DndProvider } from 'react-dnd';
...
function createScrollingComponentWithConsumer(WrappedComponent) {
  ...
  return function (props) {
    return React.createElement(DndContext, null, function (_ref3) {
      var dragDropManager = _ref3.dragDropManager;
      return dragDropManager === undefined ? null : React.createElement(ScrollingComponent, _extends({}, props, {
...
function (_Component) {
  ...
  function ReactSortableTree(props) {
    ...
    if (isVirtualized) {
      _this.scrollZoneVirtualList = (createScrollingComponent || createScrollingComponentWithConsumer)(List);
